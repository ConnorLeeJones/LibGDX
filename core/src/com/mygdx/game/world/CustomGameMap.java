...
import customgamemap.CustomGameMapData;
...
public class CustomGameMap extends GameMap {
    ...
    public CustomGameMap(){
        CustomGameMapData data = CustomGameMapLoader.loadMap("basic", "grass lands");
        this.id = data.id;
        this.name = data.name;
        this.map = data.map;
    ...
    public TileType getTileTypeByCoordinate(int layer, int col, int row) {
        ...
        return TileType.getTileById(map[layer][getHeight() - row - 1][col]);
    }
